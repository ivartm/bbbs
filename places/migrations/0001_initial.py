    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('published', models.BooleanField(default=False, verbose_name='Отображение на странице')),
                ...
                ('tags', models.ManyToManyField(related_name='placetags', to='places.PlaceTag', verbose_name='Теги')),
            ],
            options={
